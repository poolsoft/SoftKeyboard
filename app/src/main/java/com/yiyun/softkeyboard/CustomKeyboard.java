...
public class CustomKeyboard {
    ...
    public static class Row {
        ...
        public Row(CustomKeyboard parent) {
            this.parent = parent;
        }

        public Row(Resources res, CustomKeyboard parent, XmlResourceParser parser) {
            this.parent = parent;
            TypedArray a = res.obtainAttributes(Xml.asAttributeSet(parser),
                    R.styleable.Keyboard);
            Log.d(TAG, "Row attr count = "+Xml.asAttributeSet(parser).getAttributeCount());
     ...
     */
    public CustomKeyboard(Context context, int xmlLayoutResId, int modeId, int width,
                    int height) {
        mDisplayWidth = width;
    ...
    private void loadKeyboard(Context context, XmlResourceParser parser) {
        ...
        Log.d(TAG, "attr count = "+parser.getAttributeCount());
    ...
    private void parseKeyboardAttributes(Resources res, XmlResourceParser parser) {
        Log.d(TAG, "keyboard attr count = "+parser.getAttributeCount());
        TypedArray a = res.obtainAttributes(Xml.asAttributeSet(parser),
                R.styleable.Keyboard);
