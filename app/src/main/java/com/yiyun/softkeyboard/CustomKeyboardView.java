...
import com.yiyun.softkeyboard.CustomKeyboard.Row;

/**
 * Created by guanqunzhang on 2017/8/10.
 */
...
public class CustomKeyboardView extends View implements View.OnClickListener {
    ...
    /** Listener for {@link CustomKeyboardView.OnKeyboardActionListener}. */
    private CustomKeyboardView.OnKeyboardActionListener mKeyboardActionListener;
    ...
    public CustomKeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.KeyboardView, defStyleAttr, R.style.styleKeyboardViewDefault);
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                case R.styleable.KeyboardView_keyboardBackground:
...
//        mBackgroundDimAmount = a.getFloat(android.R.styleable.Theme_backgroundDimAmount, 0.5f);
    ...
    public void setOnKeyboardActionListener(CustomKeyboardView.OnKeyboardActionListener listener) {
        mKeyboardActionListener = listener;
    }

    /**
     * Returns the {@link CustomKeyboardView.OnKeyboardActionListener} object.
     * @return the listener attached to this keyboard
     */
    protected CustomKeyboardView.OnKeyboardActionListener getOnKeyboardActionListener() {
     ...
     * @see CustomKeyboard#setShifted(boolean)
     */
    ...
    /**
     * When enabled, calls to {@link CustomKeyboardView.OnKeyboardActionListener#onKey} will include key
